...
router.post('/signup', userController.createUser); // Route for creating a new user
router.get('/', protect, adminOnly, userController.getAllUsers); // Route for getting all users (protected)
